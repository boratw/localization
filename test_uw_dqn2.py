...
saver.restore(sess, "./log_dqn2_1/log_dqn2_12000.ckpt")
...
log_file = open("test_dqn2_1.txt", "wt")
...
image_path_list = []
image_path_list.extend(["/media/user/disk1/20201223_Simulation_Result/noise_no_y_0.5_0.1_test/" + x[:-8] for x in os.listdir("/media/user/disk1/20201223_Simulation_Result/noise_no_y_0.5_0.1_test/") if x[-8:] == "_cam.png"])
...
for image_path in image_path_list:
    ...
    log_file.write("result : %f\t%f\t%f\t%f\t%f\t%f\n" % 
        (noise_lat, -noise_yaw, score_o, maxret[0], maxret[2], maxscore))